...
webpush.setVapidDetails(
  ...
  process.env.VAPID_PUBLIC_KEY || 'BDt7dBtU0ajMBY5F-TpH5ZwSRTG8nJFhxWaCtMa2swYBeqtGb5w8HmbcZ2WMWdowvNIUQ_jQ2-36M7hctEpjJeI',
  process.env.VAPID_PRIVATE_KEY || 'm8CgIt2ssrWAYNKFppJRRTXrc0mtb4N61Kdfk7hbC3Q'
);
...
app.post('/api/push/test', async (req, res) => {
  ...
  await sendPushToUser(
    user_id,
    title || '✅ OSWA SCIENCE Notifications Active',
